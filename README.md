...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
 - I would tell them that semantic html is tags that have a clearly defined meaning. Tags like header, footer, and nav have a clear menaing.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
 - Display: block makes the element take up the entire width of their parent element, and start on a new line. Display: inline makes the element take up no more space than it need, and to not start on a new line.

3. What are the 4 areas of the box model?
 - Content, Padding, Border, Margin

4. While using flexbox, what axis does the following property work on: ```align-items: center```?
 - Align-items works on the vertical axis for display: row, and on the horizontal axis for display: column.

5. Explain why git is valuable to a team of developers.
 - Git is valuable to a team of developers because it stores all previos commits, allowing them to go back to a previous version in case something stops working properly.
